...
val testData = """Valve AA has flow rate=0; tunnels lead to valves DD, II, BB
...
val data = """Valve XB has flow rate=0; tunnels lead to valves WZ, LE
...
Valve AA has flow rate=0; tunnels lead to valves KE, GI, VI, YE, XC""".split("\n")